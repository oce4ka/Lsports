...
<head>
    ...
    <script>     (function (w, d, t, r, u) {
            var f, n, i;
            w[u] = w[u] || [], f = function () {
                var o = {ti: "343049508", enableAutoSpaTracking: true};
        ...
        window.LunioTrackConversion = function () {
            ...
            r.onreadystatechange = function () {
                if (this.readyState === 4 && this.status === 200) {
                    console.log('Lunio conversion tracking complete');
                }
            };
            r.send();
        }
    ...
    <!-- Hotjar Tracking Code for Lsports -->
    <script> (function (h, o, t, j, a, r) {
            h.hj = h.hj || function () {
                (h.hj.q = h.hj.q || []).push(arguments)
            };
            h._hjSettings = {hjid: 4939230, hjsv: 6};
                    ...
                    <div class="sub-menu">
                        <div class="menu-container">
                            ...
                            <div class="item item-1">
                                <?php if (!empty($fist_submenu_item['first_submenu_link'])): ?>
                                    <div class="h4"><a href="<?php echo $fist_submenu_item['first_submenu_link'] ?>"><?php echo $fist_submenu_item['first_submenu_title']; ?></a></div>
                                <?php else: ?>
                                    <div class="h4"><?php echo $fist_submenu_item['first_submenu_title']; ?></div>
                                <?php endif; ?>
                            ...
                            <div class="item item-2">
                                <?php if (!empty($second_submenu_item['second_menu_link'])): ?>
                                    <div class="h4"><a href="<?php echo $second_submenu_item['second_menu_link']; ?>"><?php echo $second_submenu_item['second_menu_title']; ?></a></div>
                                <?php else: ?>
                                    <div class="h4"><?php echo $second_submenu_item['second_menu_title']; ?></div>
                                <?php endif; ?>
                                <div class="sub-menu-block">
                                    <ul>
                            ...
                            <div class="item item-3">
                                <?php if (!empty($third_submenu_item['third_menu_link'])): ?>
                                    <div class="h4"><a href="<?php echo $third_submenu_item['third_menu_link']; ?>"><?php echo $third_submenu_item['third_menu_title']; ?></a></div>
                                <?php else: ?>
                                    <div class="h4"><?php echo $third_submenu_item['third_menu_title']; ?></div>
                                <?php endif; ?>
                                <div class="sub-menu-block">
                                    <ul>
                            ...
                            <div class="item item-4">
                                <?php if (!empty($fourth_submenu_item['fourth_menu_link'])): ?>
                                    <div class="h4"><a href="<?php echo $fourth_submenu_item['fourth_menu_link']; ?>"><?php echo $fourth_submenu_item['fourth_menu_title']; ?></a></div>
                                <?php else: ?>
                                    <div class="h4"><?php echo $fourth_submenu_item['fourth_menu_title']; ?></div>
                                <?php endif; ?>
                                <div class="sub-menu-block">
