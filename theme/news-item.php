...
<section class="s-news-post bg-grey">
    <div class="container container--post">
        <div class="s-news-post__header">
                        <?php /* <a href="<?php echo $category_link ?>" class="back">Back to lobby ></a> */ ?>
            <div class="meta">
<div class="type"><a class="links2024-2" href="<?php echo $category_link ?>" class="back"><?php echo $category_name ?></a></div>
